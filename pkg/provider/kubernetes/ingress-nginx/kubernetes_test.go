				...
				HTTP: &dynamic.HTTPConfiguration{
					Routers: map[string]*dynamic.Router{
						"default-ingress-with-external-name-rule-0-path-0": {
							EntryPoints: []string{"http"},
							Rule:        `Host("external.localhost") && Path("/external-with-port")`,
							RuleSyntax:  "default",
						...
						"default-ingress-with-external-name-rule-0-path-1": {
							EntryPoints: []string{"http"},
							Rule:        `Host("external.localhost") && Path("/external-with-named-port")`,
							RuleSyntax:  "default",
						...
						"default-ingress-with-external-name-rule-0-path-2": {
							EntryPoints: []string{"http"},
							Rule:        `Host("external.localhost") && Path("/external-without-port")`,
							RuleSyntax:  "default",
						...
						"default-ingress-with-external-name-rule-0-path-3": {
							EntryPoints: []string{"http"},
							Rule:        `Host("external.localhost") && Path("/external-without-named-port")`,
							RuleSyntax:  "default",
