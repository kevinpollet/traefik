...
// DisableServiceMetricsKey is a context key used to disable the metrics produced at the service level.
const DisableServiceMetricsKey contextKey = iota
...
func WrapServiceHandler(ctx context.Context, registry metrics.Registry, serviceName string) alice.Constructor {
	return func(next http.Handler) (http.Handler, error) {
		...
		return http.HandlerFunc(func(rw http.ResponseWriter, req *http.Request) {
			if val := req.Context().Value(DisableServiceMetricsKey); val != nil {
