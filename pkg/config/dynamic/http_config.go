...
type Spiffe struct {
	...
	IDs []string `description:"Defines the allowed SPIFFE IDs (takes precedences over the SPIFFE TrustDomain)." json:"ids,omitempty" toml:"ids,omitempty" yaml:"ids,omitempty"`
