...
type Experimental struct {
	...
	MultiProviders    bool `description:"Allow multi providers usage." json:"multiProviders,omitempty" toml:"multiProviders,omitempty" yaml:"multiProviders,omitempty" export:"true"`
